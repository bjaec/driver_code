...
#define SERVO_PIN 37  // GPIO pin for the servo motor
...
void camera_init() {
    camera_config_t config = {
        ...
        .jpeg_quality = 63,           // JPEG quality (1-63, lower is better quality)
...
void app_main() {
    ...
    // Create button task to run concurrently with the main loop
